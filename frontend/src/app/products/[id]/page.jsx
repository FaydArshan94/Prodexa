...
const similarProducts = [
  ...
  { id: 9, name: 'Bluetooth Speaker', price: 1999, originalPrice: 3999, rating: 4.6, reviews: 567, image: '🔊', discount: '50% OFF' },
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <Card className="aspect-square flex items-center justify-center bg-slate-50 p-8">
            ...
            <div className="grid grid-cols-4 gap-2">
              {product.images.map((img, idx) => (
                <Card 
                  ...
                  className={`aspect-square flex items-center justify-center cursor-pointer hover:border-blue-500 transition-all ${selectedImage === idx ? 'border-2 border-blue-500' : ''}`}
                >
          ...
          <div className="space-y-6">
            ...
            {/* Stock Status */}
            <div className={`inline-flex items-center gap-2 px-3 py-1 rounded ${product.inStock ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
            ...
            <div className="text-sm text-slate-600">
              Sold by: <span className="text-blue-600 font-semibold">{product.seller}</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4">
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">On orders above ₹499</div>
                </div>
              </div>
              <div className="flex flex-col items-center text-center gap-2">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-slate-500 mt-1">{product.reviews} reviews</div>
                  </div>
                  <Button>Write a Review</Button>
                </div>
                <div className="text-slate-600">Customer reviews will appear here...</div>
              </div>
            )}
          </div>
        </Card>
